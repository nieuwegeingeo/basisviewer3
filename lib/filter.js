...
function createLayerFilter(layers) {
    ...
    layers.forEach(layer => {
        ...
        if (filterArray !== undefined) {
            ...
            createNode(`.filter-${layerId}`,'div',[`filter-body-${layerId}`,'filter-body']);
            let filterBody = document.querySelector(`.filter-body-${layerId}`);
            ...
            let confirmButton = document.querySelector(`.button-confirm-${layerId}`);
            let resetButton = document.querySelector(`.button-reset-${layerId}`);
