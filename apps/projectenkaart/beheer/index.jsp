...
File f = new File("./webapps/apps/projectenkaart/beheer"); // current directory if started as Tomcat Windows Service
if(!f.exists() || !f.isDirectory()){
	f = new File("../webapps/apps/projectenkaart/beheer"); // current directory if started in cmd box
}
...
%>
            <div class="labelCont-block no-select">
                <a class="label-block" id="<%=file.getName()  %>"
                    href="${pageContext.request.contextPath}/projectenkaart/beheer/<%=file.getName()  %>"><span><%=file.getName().replace("_"," ").substring(0, 1).toUpperCase() + file.getName().replace("_"," ").substring(1)%></span>
                    <br>
     ...
     for (File listItem : list) {
        ...
        %>
                    <img class="thumbnail"
                        src="${pageContext.request.contextPath}/projectenkaart/beheer/<%=file.getName()%>/thumbnail.png">
                    <%
        }
     }
    %>
...
File f2 = new File("./webapps/apps/projectenkaart/beheer"); // current directory if started as Tomcat Windows Service
if(!f2.exists() || !f2.isDirectory()){
	f2 = new File("../webapps/apps/projectenkaart/beheer"); // current directory if started in cmd box
}
...
%>
        <div class="labelCont-list">
            <a class="label-list visible" id="<%=file2.getName()  %>"
                href="${pageContext.request.contextPath}/projectenkaart/beheer/<%=file2.getName()  %>"><span><%=file2.getName() %></span></a>
            <a href="#" class="preview"
                onclick="document.getElementById('kaart').src='${pageContext.request.contextPath}/projectenkaart/beheer/<%=file2.getName() %>'"><img
...
%>
    ...
    <div id="kaartdiv" class="">
        <iframe id="kaart" src="../beheer/projectenkaart_algemeen" style="height:100%;width:100%;"></iframe>
    </div>
