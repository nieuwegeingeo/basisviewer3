...
overLays: [

        {
          ...
          fields: {
              'nieuwegein:bedrijven_actualisatie_app' : {
                    ...
                    'BIJZONDERHEDEN_OOV_TEKST' : 'Bijzonderheden OOV',
    ...
    multiFilter: [{
        ...
        'BIJZONDERHEDEN_OOV_TEKST': {
            TYPE: 'TEXT',
            TITLE: 'Bijzonderheden OOV',
        },
        'RELEVANTIE': {
            TYPE: 'RADIO',
            TITLE: 'Relevantie',
...
Geogem.applicatieInit = function(){
    ...
    Geogem.featureTypes = {
        ...
        'ELE0-5':{CONTENT: '<section class="form-section zichtbaar-flex flex-wrap"><details open><summary class="form-summary">Bijzonderheden OOV</summary><div class="flex-container">',TYPE: 'ELEMENT'},
        
        'BIJZONDERHEDEN_OOV_TEKST':{
			TITLE: 'Bijzonderheden OOV opmerking',
			TYPE: 'TEXTAREA'
		},
        ...
        'ELE8-1':{CONTENT: '<section class="form-section zichtbaar-flex flex-wrap"><details open><summary class="form-summary">Bijzonderheden overig</summary><div class="flex-container">',TYPE: 'ELEMENT'},
        ...
        // 'TOELICHTING_DOORVERWIJZING':{
			...
			// TYPE: 'TEXTAREA'
		// },
        'ELE8-2':{CONTENT: '</div></details></section>',TYPE: 'ELEMENT'},
